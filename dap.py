...
# Drop rows with missing values in deliveries
...
# Create a new feature: 'match_year'
...
# Merge total runs per match back to matches dataframe
...
# Identify outliers in 'total_runs' using IQR
